function MultiSelectTag(e, t = { shadow: !1, rounded: !0 }) {
  var l = null,
    ...
    p = null,
    h = t.tagColor || {};
  (h.textColor = h.textColor || "#6930C3"),
    (h.borderColor = h.borderColor || "#6930C3"),
  ...
  this.removeElements = function (values){
    values.forEach(value => {
      el = n.find((t) => t.value == value)
      if(el){
        el.selected = !1;
        w(value);
      }
  ...
  this.getValues = function(){
    return n.filter((item)=>{return item.selected});
  }
  this.getAllValues = function(){
    return n
  }
  this.modifyDomain = function(newDomain){
    if (newDomain.length === 0) {
      n = newDomain
    } else {
      commonDomain = []
      for (let i = 0; i < newDomain.length; i++) {
        domainObj = {...newDomain[i],selected:false}
        value = domainObj.value;
        existElement = n.find((item)=>{return item.value == value})
        if(existElement && existElement.selected){
          domainObj.selected = true
        }
        commonDomain.push(domainObj)
      }
      n = commonDomain
    }
    f();
    ...
    for (var e of p.children)
      e.addEventListener("click", (e) => {
        !1 === n.find((t) => t.value == e.target.dataset.value).selected
          ? ((n.find((t) => t.value == e.target.dataset.value).selected = !0),
            (c.value = null),
            f(),
            E())
          : ((n.find((t) => t.value == e.target.dataset.value).selected = !1),
            (c.value = null),
            f(),
            E(),
  ...
  function E(e = !0) {
    ...
    for (var a = 0; a < n.length; a++)
      (l.options[a].selected = n[a].selected),
        n[a].selected &&
          selected_values.push({ label: n[a].label, value: n[a].value });
  ...
  (l = document.getElementById(e)),
    (function () {
      (n = [...l.options].map((e) => ({
        ...
        r.append(c),
        o.append(i),
        (s = document.createElement("div")).classList.add("btn-container","invisible"),
